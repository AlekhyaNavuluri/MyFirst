...
namespace SeatBooking
{
    partial class Form2
    {
        ...
        private void CreateNewCourseForm()
        {
            ...
            for (int i = 0; i < courseDeatilsArray.Length; i++)
            {
                ...
                label.TabIndex = 2;
                label.Text = "Enter "+courseDeatilsArray[i];
                label.Hide();
                left += 204;
                ...
                textBox1.Name = courseDeatilsArray[i];
        ...
        private void HideNewCourseContents()
        {
           
        }

        private void ShowNewCourseContents()
        {
        ...
        private readonly string[] courseDeatilsArray = new string[4] { "Course Name", "Course StartDate", "Course Fee","Course Capacity" };
        private readonly string fileName = @"C:\Users\alekhya\Documents\log.txt";
        private ToolStripMenuItem exitToolStripMenuItem;
        private const int MaximunCourseDatesAvailable = 5;
    }
}